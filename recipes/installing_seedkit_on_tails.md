...
- seedkit_0.3.3_checksums.txt
- seedkit_0.3.3_checksums.txt.sig
...
```bash
gpg --verify seedkit_0.3.3_checksums.txt.sig seedkit_0.3.3_checksums.txt
```
...
```bash
grep Linux_x86_64 seedkit_0.3.3_checksums.txt | sha256sum -c
# and/or:
grep Linux_arm64 seedkit_0.3.3_checksums.txt | sha256sum -c
```
