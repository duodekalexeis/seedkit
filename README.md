...
For test purposes use the [official release tarballs](https://github.com/duodekalexeis/seedkit/releases/latest), or build from source:

```bash
go install github.com/duodekalexeis/seedkit@latest
``` 

To install on Tails, see the [Installing seedkit on tails](https://github.com/duodekalexeis/seedkit/blob/main/recipes/installing_seedkit_on_tails.md) recipe.


Usage
-----

Specific use cases are documented in more detail in the [recipes folder](https://github.com/duodekalexeis/seedkit/tree/main/recipes) e.g.

- [Reproducing a seedkit build](https://github.com/duodekalexeis/seedkit/blob/main/recipes/reproducing_a_seedkit_build.md)
- [Installing seedkit on tails](https://github.com/duodekalexeis/seedkit/blob/main/recipes/installing_seedkit_on_tails.md)
- [Generating a BIP-39 mnemonic seed from words](https://github.com/duodekalexeis/seedkit/blob/main/recipes/generating_a_bip39_mnemonic_seed_from_the_bip39_wordlist.md)
- [Generating SLIP-39 shares from a BIP-39 seed](https://github.com/duodekalexeis/seedkit/blob/main/recipes/generating_slip39_shares_from_a_bip39_seed.md)
...
- [go-slip39](https://github.com/duodekalexeis/go-slip39)
